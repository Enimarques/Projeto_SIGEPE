...
if errorlevel 1 (
    ...
    echo.
    echo Caso continue com problemas no dlib, baixe a wheel correspondente ao seu Python e Windows em:
    echo   https://www.lfd.uci.edu/~gohlke/pythonlibs/#dlib
    echo E instale manualmente com:
    echo   py -m pip install caminho\para\dlib-<versao>.whl
    echo.
